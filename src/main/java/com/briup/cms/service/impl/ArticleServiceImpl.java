...
public class ArticleServiceImpl implements IArticleService {
    ...
    public void addArticle(Article article) throws CustomerException {
        if (article == null){
            throw new CustomerException(CodeUtil.BAD_CODE, "参数异常");
        }
    ...
    @Override
    public void deleteAllArticle() throws CustomerException {
        articleDao.deleteAll();
    }

    @Override
    public List<Article> selectAllArticle() throws CustomerException {
